...
class FormIzinMelahirkan extends StatelessWidget {
  ...
  DateTime tglMelahirkan1;
  DateTime tglMelahirkan2;
  String? izinMelahirkanUser;
  TextEditingController izinMelahirkanKet;
  FormIzinMelahirkan({
    super.key,
    ...
    required this.tglMelahirkan1,
    required this.tglMelahirkan2,
    required this.izinMelahirkanUser,
    required this.izinMelahirkanKet,
  });
            ...
            child: Column(
              children: [
                ...
                CupertinoButton(
                  ...
                  onPressed: () {
                    print(
                      tglMelahirkan1.simpleDateRevers(),
                    );
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                tglMelahirkan1.simpleDateRevers().toString(),
            ...
            child: Column(
              children: [
                ...
                CupertinoButton(
                  ...
                  onPressed: () {
                    print(
                      tglMelahirkan2.simpleDateRevers().toString(),
                    );
                    Navigator.of(context).pop();
                  },
                )
