...
class PengajuanIzin extends StatelessWidget {
  ...
  PengajuanIzin({
    ...
    required this.pengajuanIzinUser,
    required this.pengajuanIzinKet,
                              ...
                              Expanded(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    spaceHeight(5),
                                    formJamIzin2(context, data['inputan'])
                                  ],
                                ),
                              ),
                            ],
  ...
  InkWell formJamIzin(BuildContext context, inputan) {
    return InkWell(
      onTap: () async {
  ...
  InkWell formJamIzin2(BuildContext context, inputan) {
    return InkWell(
      onTap: () async {
        showCupertinoModalPopup(
          context: context,
