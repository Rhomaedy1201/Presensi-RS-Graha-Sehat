...
ConfirmTukarJadwalModel confirmTukarJadwalModelFromJson(String str) =>
    ConfirmTukarJadwalModel.fromJson(json.decode(str));

String confirmTukarJadwalModelToJson(ConfirmTukarJadwalModel data) =>
    json.encode(data.toJson());

class ConfirmTukarJadwalModel {
  String message;
  int statusCode;
  List<Datum> data;

  ConfirmTukarJadwalModel({
    required this.message,
    required this.statusCode,
    required this.data,
  });

  factory ConfirmTukarJadwalModel.fromJson(Map<String, dynamic> json) =>
      ConfirmTukarJadwalModel(
